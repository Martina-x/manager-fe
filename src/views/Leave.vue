<template>
  <div class="user-manager">
      ...
      <el-table :data="applyList">
        ...
        <el-table-column fixed="right" label="操作" width="155">
          <template #default="scope">
            ...
            <el-button type="danger" size="small" @click="handleDelete(scope.row._id)" v-if="[1,2].includes(scope.row.applyState)">作废</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog v-model="showModal" title="申请休假" :close-on-click-modal="false" :close-on-press-escape=false
